...
def train_fold(fold_idx, train_cases, val_cases, args, channels, device):
    ...
    full_train = BraTSDataset3D("data/data/raw/ASNR-MICCAI-BraTS2023-GLI-Challenge-TrainingData", augment=True)
    full_val   = BraTSDataset3D("data/data/raw/ASNR-MICCAI-BraTS2023-GLI-Challenge-TrainingData", augment=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--folds_json",
        type=str,
        default="/data/data/folds/folds.json",
